...
class serial_plotter_class:
	...
	def animate(self, i):
            for index in range(0, len(self.curve_indexs)):
                print(self.serial_data[self.curve_indexs[index]].data)
