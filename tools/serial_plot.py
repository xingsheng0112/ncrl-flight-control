...
class serial_plotter_class:
    ...
    def set_figure(self, message_id):
        if(message_id == 0):
            ...
            plt.ylabel('ICL CoG')
            plt.ylim([-1, 1])
            self.create_curve('Ixx', 'green')
            self.create_curve('Iyy', 'pink')
            self.create_curve('Izz', 'gray')
            self.create_curve('Ixy', 'green')
            self.create_curve('Ixz', 'pink')
            self.create_curve('Iyz', 'gray')
            self.show_subplot()
