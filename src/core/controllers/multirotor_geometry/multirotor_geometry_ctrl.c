...
float Gamma_gain[6] = {1.15f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f};
float k_icl_gain = 1;
...
void geometry_ctrl_init(void)
{
	...
	MAT_INIT(y_clT, 4, 4);
	MAT_INIT(y_clT_F_y_cltheta, 4, 1);
	MAT_INIT(ICL_theta_hat_dot, 4, 1);
	...
	mat_data(theta)[4] = 0.3f;
	mat_data(theta)[5] = 0.3f;
